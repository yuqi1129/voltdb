...
public abstract class UpdateApplicationBase extends VoltNTSystemProcedure {
    ...
    private static boolean validateKiplingUpdates(CatalogMap<Table> newTables, DeploymentType newDep, DeploymentType curDep,
        ...
        // Build a usage map of profiles, with defaults identified by an invalid blank name of 1 whitespace
     ...
     *                     the default profile being identified by a blank name of 1 whitespace
     * @param newDep    new deployment
     * @param curDep    current deployment
    ...
    private static void validateTopicUpdates(Map<String, Integer> usedProfiles, DeploymentType newDep, DeploymentType curDep,
        ...
        validateRetentionUpdate("topic defaults", usedProfiles.get(" "), newDefaults.getRetention(),
    ...
    private final static void validateRetentionUpdate(String what, Integer useCount, TopicRetentionType newRetention,
